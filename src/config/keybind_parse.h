...
namespace umbriel {
  ...
  enum class KeybindAction {
    ...
    WindowFocusUp,
    WindowFocusDown,
    WindowFocusUpOrWorkspacePrevious,
    WindowFocusDownOrWorkspaceNext,
    ColumnMoveLeft,
    ColumnMoveRight,
    WindowMoveOrToOutputLeft,
    WindowMoveOrToOutputRight,
    WindowMoveUp,
    WindowMoveDown,
    WindowMoveUpOrToWorkspacePrevious,
    WindowMoveDownOrToWorkspaceNext,
    WindowConsumeLeft,
    WindowExpelRight,
    WindowCycleWidth,
