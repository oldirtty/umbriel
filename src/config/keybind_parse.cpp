...
namespace umbriel {
  ...
  namespace {
    ...
    constexpr ActionSpec kActionSpecs[] = {
        ...
        {"window-focus-down-or-workspace-next", "", KeybindAction::WindowFocusDownOrWorkspaceNext},
        ...
        {"window-focus-up-or-workspace-previous", "", KeybindAction::WindowFocusUpOrWorkspacePrevious},
        ...
        {"window-move-or-to-output-left", "", KeybindAction::WindowMoveOrToOutputLeft},
        {"window-move-or-to-output-right", "", KeybindAction::WindowMoveOrToOutputRight},
        ...
        {"window-move-up-or-to-workspace-previous", "", KeybindAction::WindowMoveUpOrToWorkspacePrevious},
